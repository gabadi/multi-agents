...
This role runs in **RPC mode** (`mode: rpc`). It processes structured contracts via mailbox and does not need a TTY. It is the only role authorized for push and PR operations.
