...
This role runs in **RPC mode** (`mode: rpc`). It processes structured contracts via mailbox and does not need a TTY. It is focused on read-heavy architecture review and design documentation.
